...
},{}],"../src/v-icon.vue":[function(require,module,exports) {
"use strict";
...
},{"./v-icon.vue":"../src/v-icon.vue","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.common.js"}],"button.test.js":[function(require,module,exports) {
"use strict";
...
describe('Button', function () {
  it('存在.', function () {
    _vButton.default.should.to.be.ok;
  });
  it('可以设置icon.', function () {
    var Constructor = _vue.default.extend(_vButton.default);
    ...
    expect(useElement.getAttribute('xlink:href')).to.equal('#icon-arrow-left');
    vm.$destroy();
  });
  ...
  it('点击 button 触发 click 事件', function () {
    ...
    vm.$el.click();
    callback.should.have.called; // expect(callback).to.have.been.called
  });
});
},{"vue":"../node_modules/vue/dist/vue.common.js","../src/v-button":"../src/v-button.vue"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
